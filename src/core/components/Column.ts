...
export class Column extends Component {
    ...
    onLoad(): void {
        ...
        for (const i of meshList) {
            let columeInstance = this.columeInstanceMap.get(i.Object);

            if (!columeInstance) {
                columeInstance = { indexList: [], instance: [] };
                this.columeInstanceMap.set(i.Object, columeInstance);
            }

            columeInstance.indexList.push(i);
        }
        //根据所得的名称加载glb
